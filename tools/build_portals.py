...
def build(v,lang):
 ...
 source=source.replace('takeda-kinetic-g',f'takeda-kinetic-{v}').replace('G | Research list',f'{v.upper()} | '+('Layered studio' if v=='h' else 'Research atlas'))
 ...
 if v=='h':
  source=source.replace('</head>','<link rel="stylesheet" href="takeda-h-studio.css?v=2"></head>')
 ...
 if v=='h':
  media=f'''<figure class="studio-visual" aria-label="{t('研究領域をイメージした立体アート。仮ビジュアル。','Sculptural study inspired by the research fields. Placeholder visual.')}"><div class="studio-disc" aria-hidden="true"></div><div class="studio-orbit orbit-one" aria-hidden="true"></div><div class="studio-orbit orbit-two" aria-hidden="true"></div><span class="studio-type" aria-hidden="true">Takeda<span>Lab.</span></span><img class="studio-object" src="assets/concept-kinetic-object.png" width="1280" height="1280" alt=""><span class="studio-cross" aria-hidden="true">＋</span><figcaption><span>CG · XR · GENERATIVE AI</span><span>{t('研究領域のイメージ','Research imagery')}</span></figcaption></figure>'''
