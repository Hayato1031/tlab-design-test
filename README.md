...
[7案を比較する](https://hayato1031.github.io/tlab-design-test/) · [新しいG案を開く](https://hayato1031.github.io/tlab-design-test/takeda-kinetic-g.html)
...
7案とも日本語・英語のページがあります。A〜Cの研究テーマは約5.8秒ごとに自動で切り替わります。手動のスライド操作はありません。動きを減らす端末設定では静止表示になります。D・E・F・Gはスライドや導入用の大きなビジュアルを持ちません。
...
- `takeda-kinetic-a.html`〜`takeda-kinetic-g.html`：日本語の各案
- `takeda-kinetic-a-en.html`〜`takeda-kinetic-g-en.html`：英語の各案
- `index.html` / `takeda-kinetic-compare.html`：7案の比較
- `takeda-kinetic-review-a.html`〜`takeda-kinetic-review-g.html`：PC・スマホのスクリーンショット比較
